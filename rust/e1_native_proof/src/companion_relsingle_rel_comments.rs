...
// GENERATED by litedbmodel codegen — the CHILD relation de-box companion for `generated_relsingle_rel_comments` (#140).
...
use super::generated_relsingle_rel_comments::*;
...
impl HandlerNRRelComments for DeBox {
    type Wire = Wire;
    fn node_n0(&self, _ports: &PortsNRRelCommentsN0, _bound: Option<String>) -> Result<Wire, BehaviorError> {
...
pub fn decode(wire: Wire) -> Result<Vec<T0>, litedbmodel_runtime::RuntimeError> {
    run_native_raw_struct_RelComments(&DeBox { wire: std::cell::RefCell::new(Some(wire)) }, InNRRelComments)
