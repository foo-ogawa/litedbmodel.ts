...
/// The litedbmodel-consumer entry: build the runtime-backed handler for `UpsertMany`. The consumer
/// calls `run_native_raw_struct_UpsertMany(&handler(driver), in_)` — supplying NO node_* itself.
