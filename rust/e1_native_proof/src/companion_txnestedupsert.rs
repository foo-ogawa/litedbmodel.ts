...
pub fn run_on(src: litedbmodel_runtime::ConnSource, connection: Option<&str>, dialect: litedbmodel_runtime::TxDialect, options: &litedbmodel_runtime::TransactionOptions, in_: InNRTxNestedUpsert) -> Result<bool, BehaviorError> {
    litedbmodel_runtime::run_transaction_on(src, connection, dialect, options, |ctx| run_native_raw_struct_TxNestedUpsert(&TxRt { ctx }, in_)).map_err(cvt)
}
