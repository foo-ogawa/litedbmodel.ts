...
/// The litedbmodel-consumer entry: build the runtime-backed handler for `FindUnique`. The consumer
/// calls `run_native_raw_struct_FindUnique(&handler(driver), in_)` — supplying NO node_* itself.
