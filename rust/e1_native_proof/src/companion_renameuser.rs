...
use super::generated_renameuser::*;
...
/// The litedbmodel-consumer entry: build the runtime-backed handler for `RenameUser`. The consumer
/// calls `run_native_raw_struct_RenameUser(&handler(driver), in_)` — supplying NO node_* itself.
