...
// GENERATED by litedbmodel codegen — the RUST COMPANION for `generated_recent` (epic #123/#124).
...
/// The litedbmodel-consumer entry: build the runtime-backed handler for `Recent`. The consumer
/// calls `run_native_raw_struct_Recent(&handler(driver), in_)` — supplying NO node_* itself.
