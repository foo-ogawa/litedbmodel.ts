...
pub fn hydrate_comments<P, K: litedbmodel_runtime::IntoKeyTuple>(
    op: &litedbmodel_runtime::Node,
    parents: Vec<P>,
    key_of: impl Fn(&P) -> K,
    driver: &dyn litedbmodel_runtime::Driver,
) -> Result<Vec<(P, Vec<super::generated_relsingle_rel_comments::T0>)>, litedbmodel_runtime::RuntimeError> {
    let level = litedbmodel_runtime::hydrate_relation_typed(
        op, parents, key_of,
        super::companion_relsingle_rel_comments::decode,
