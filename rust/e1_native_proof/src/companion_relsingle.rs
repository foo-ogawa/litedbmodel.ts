...
/// The litedbmodel-consumer entry: build the runtime-backed handler for `ByAuthor`. The consumer
/// calls `run_native_raw_struct_ByAuthor(&handler(driver), in_)` — supplying NO node_* itself.
