...
// GENERATED by litedbmodel codegen — the RUST COMPANION for `generated_tenantfeed` (epic #123/#124).
...
use super::generated_tenantfeed::*;
...
/// The litedbmodel-consumer entry: build the runtime-backed handler for `UsersWithPosts`. The consumer
/// calls `run_native_raw_struct_UsersWithPosts(&handler(driver), in_)` — supplying NO node_* itself.
