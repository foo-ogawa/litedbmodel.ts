...
/// The litedbmodel-consumer entry: build the runtime-backed handler for `ByIds`. The consumer
/// calls `run_native_raw_struct_ByIds(&handler(driver), in_)` — supplying NO node_* itself.
