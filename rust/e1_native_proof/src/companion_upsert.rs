...
/// The litedbmodel-consumer entry: build the runtime-backed handler for `UpsertUser`. The consumer
/// calls `run_native_raw_struct_UpsertUser(&handler(driver), in_)` — supplying NO node_* itself.
