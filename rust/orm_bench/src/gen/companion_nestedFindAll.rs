...
// GENERATED by litedbmodel codegen — the RUST COMPANION for `generated_nestedFindAll` (epic #123/#124).
...
use super::generated_nestedFindAll::*;
...
) -> Result<Vec<(P, Vec<super::generated_nestedFindAll_rel_posts::T0>)>, litedbmodel_runtime::RuntimeError> {
    let level = litedbmodel_runtime::hydrate_relation_typed(
        op, parents, key_of,
        super::companion_nestedFindAll_rel_posts::decode,
