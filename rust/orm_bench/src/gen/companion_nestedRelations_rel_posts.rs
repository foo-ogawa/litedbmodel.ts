...
// GENERATED by litedbmodel codegen — the CHILD relation de-box companion for `generated_nestedRelations_rel_posts` (#140).
...
use super::generated_nestedRelations_rel_posts::*;
