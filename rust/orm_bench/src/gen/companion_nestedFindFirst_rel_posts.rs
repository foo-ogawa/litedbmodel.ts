...
// GENERATED by litedbmodel codegen — the CHILD relation de-box companion for `generated_nestedFindFirst_rel_posts` (#140).
...
use super::generated_nestedFindFirst_rel_posts::*;
