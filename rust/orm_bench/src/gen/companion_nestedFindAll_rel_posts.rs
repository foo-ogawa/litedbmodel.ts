...
// GENERATED by litedbmodel codegen — the CHILD relation de-box companion for `generated_nestedFindAll_rel_posts` (#140).
...
use super::generated_nestedFindAll_rel_posts::*;
