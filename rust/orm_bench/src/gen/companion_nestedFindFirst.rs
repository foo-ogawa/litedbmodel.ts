...
// GENERATED by litedbmodel codegen — the RUST COMPANION for `generated_nestedFindFirst` (epic #123/#124).
...
use super::generated_nestedFindFirst::*;
...
impl<'a> HandlerNRFindFirst for Rt<'a> {
    type Wire = Wire;
    fn node_n0(&self, ports: &PortsNRFindFirstN0, _bound: Option<String>) -> Result<Wire, BehaviorError> {
...
) -> Result<Vec<(P, Vec<super::generated_nestedFindFirst_rel_posts::T0>)>, litedbmodel_runtime::RuntimeError> {
    let level = litedbmodel_runtime::hydrate_relation_typed(
        op, parents, key_of,
        super::companion_nestedFindFirst_rel_posts::decode,
