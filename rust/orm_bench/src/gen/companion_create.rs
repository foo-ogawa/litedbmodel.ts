...
// GENERATED by litedbmodel codegen — the RUST COMPANION for `generated_create` (epic #123/#124).
...
impl<'a> HandlerNRCreate for Rt<'a> {
    type Wire = Wire;
    fn node_n0(&self, ports: &PortsNRCreateN0, _bound: Option<String>) -> Result<Wire, BehaviorError> {
