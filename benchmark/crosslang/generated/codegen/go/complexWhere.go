...
const IRFingerprint = "fnv1a64:ead6ce5e6e15d33f"

// ComponentNames are the components exposed by Bind(), in IR declaration order.
var ComponentNames = []string{"ComplexWhere"}
...
func run_ComplexWhere(handlers dslcontracts.ComponentExec, input *dslcontracts.Obj) (dslcontracts.Value, error) {
	if input == nil {
	...
	pv_n0___scope := slVE2(dslcontracts.PrimObj(dslcontracts.JObjOf("author_id", dslcontracts.JObjOf("ref", []dslcontracts.JNode{"author_id"}), "since", dslcontracts.JObjOf("ref", []dslcontracts.JNode{"since"}), "titleLike", dslcontracts.JObjOf("ref", []dslcontracts.JNode{"titleLike"}), "ids", dslcontracts.JObjOf("ref", []dslcontracts.JNode{"ids"})), scope))
...
func dispatch(name string, handlers dslcontracts.ComponentExec, input *dslcontracts.Obj) (dslcontracts.Value, error) {
	if name == "ComplexWhere" {
		return run_ComplexWhere(handlers, input)
	}
