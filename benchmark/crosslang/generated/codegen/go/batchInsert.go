	...
	"components", []dslcontracts.JNode{
		dslcontracts.JObjOf(
			...
			"inputPorts", dslcontracts.JObjOf(
				"__sql", dslcontracts.JObjOf(
					"type", "string",
					"required", true,
				),
				"__sqlParams", dslcontracts.JObjOf(
					"type", "arr",
				),
				"__skip", dslcontracts.JObjOf(
					"type", "bool",
				),
			),
			"body", []dslcontracts.JNode{
				dslcontracts.JObjOf(
					...
					"ports", dslcontracts.JObjOf(
						"sql", dslcontracts.JObjOf(
							"ref", []dslcontracts.JNode{
								"__sql",
							},
						),
						"params", dslcontracts.JObjOf(
							"ref", []dslcontracts.JNode{
								"__sqlParams",
							},
						),
						"skip", dslcontracts.JObjOf(
							"ref", []dslcontracts.JNode{
								"__skip",
							},
						),
