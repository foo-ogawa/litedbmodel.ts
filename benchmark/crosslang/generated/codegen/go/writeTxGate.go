...
const IRFingerprint = "fnv1a64:9ef9671fecd59dd0"

// ComponentNames are the components exposed by Bind(), in IR declaration order.
var ComponentNames = []string{"Create"}
...
func run_Create(handlers dslcontracts.ComponentExec, input *dslcontracts.Obj) (dslcontracts.Value, error) {
	if input == nil {
...
func dispatch(name string, handlers dslcontracts.ComponentExec, input *dslcontracts.Obj) (dslcontracts.Value, error) {
	if name == "Create" {
		return run_Create(handlers, input)
	}
