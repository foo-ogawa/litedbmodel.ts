...
// irFingerprint: fnv1a64:5e989cf7594927a8
...
const IRFingerprint = "fnv1a64:5e989cf7594927a8"

// ComponentNames are the components exposed by Bind(), in IR declaration order.
var ComponentNames = []string{"ByIds"}
...
func run_ByIds(handlers dslcontracts.ComponentExec, input *dslcontracts.Obj) (dslcontracts.Value, error) {
	if input == nil {
	...
	pv_n0___scope := slVE2(dslcontracts.PrimObj(dslcontracts.JObjOf("ids", dslcontracts.JObjOf("ref", []dslcontracts.JNode{"ids"})), scope))
...
func dispatch(name string, handlers dslcontracts.ComponentExec, input *dslcontracts.Obj) (dslcontracts.Value, error) {
	if name == "ByIds" {
		return run_ByIds(handlers, input)
	}
