...
pub const IR_FINGERPRINT: &str = "fnv1a64:ead6ce5e6e15d33f";

/// Component names exposed by bind(), in IR declaration order.
pub const COMPONENT_NAMES: [&str; 1] = ["ComplexWhere"];
...
fn run_ComplexWhere<H: ComponentExec>(
    handlers: &mut H,
    input: &[(String, Value)],
    ...
    let eval_ports_n0 = || -> Result<Vec<(String, Value)>, behavior_contracts::ExprFailure> { Ok(vec![
        ("__scope".to_string(), (primitives::obj(&json!({ "author_id": { "ref": ["author_id"] }, "since": { "ref": ["since"] }, "titleLike": { "ref": ["titleLike"] }, "ids": { "ref": ["ids"] } }), &scope))?),
    ]) };
...
impl<H: ComponentExec> Bound<H> {
    pub fn call(&mut self, name: &str, input: &[(String, Value)]) -> Result<Value, BehaviorError> {
        match name {
        "ComplexWhere" => run_ComplexWhere(&mut self.handlers, input),
