...
$componentFns = [
    "BatchInsert" => static function (array $handlers, array $input) use ($__P, $__sl_bind, $__sl_field, $__sl_cat, $__sl_ref, $__sl_ref_opt, $__sl_concat, $__bhFail, $__planFail): mixed {
        // ── op 'q' (makeSQL) ──
        $ports_q = [
    ...
    'bind' => static function (array $handlers) use ($componentNames, $componentFns, $__bhFail): array {
        ...
        foreach ($componentNames as $name) {
            $bound[$name] = static function (array $input = []) use ($name, $handlers, $componentFns, $__bhFail): mixed {
                if ($name === "BatchInsert") return ($componentFns["BatchInsert"])($handlers, $input);
