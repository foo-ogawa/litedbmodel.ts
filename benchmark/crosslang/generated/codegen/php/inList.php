...
$componentFns = [
    "ByIds" => static function (array $handlers, array $input) use ($__P, $__sl_bind, $__sl_field, $__sl_cat, $__sl_ref, $__sl_ref_opt, $__sl_concat, $__bhFail, $__planFail): mixed {
        $scope = $input;
        // ── op 'n0' (__makeSqlNode) ──
        $ports_n0 = [
            "__scope" => $__P::obj((object) ["ids" => (object) ["ref" => ["ids"]]], $scope),
        ];
    ...
    'bind' => static function (array $handlers) use ($componentNames, $componentFns, $__bhFail): array {
        ...
        foreach ($componentNames as $name) {
            $bound[$name] = static function (array $input = []) use ($name, $handlers, $componentFns, $__bhFail): mixed {
                if ($name === "ByIds") return ($componentFns["ByIds"])($handlers, $input);
