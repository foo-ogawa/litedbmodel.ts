...
// Row_NestedUpdate_tx_body_0 — CONCRETE handler-result row (typed fields = the node's outType; + error signal).
type Row_NestedUpdate_tx_body_0 struct {
	IsError bool
	Err     string
	Id int64 // "id"
	Name string // "name"
...
// Row_NestedUpdate_tx_body_1 — CONCRETE handler-result row (typed fields = the node's outType; + error signal).
type Row_NestedUpdate_tx_body_1 struct {
	IsError bool
	Err     string
	Id int64 // "id"
	Title string // "title"
...
// Handler_NestedUpdate — the CONCRETE per-component handler seam: one typed method
...
type Handler_NestedUpdate interface {
	Node_NestedUpdate_tx_body_0(ports PortsNR_NestedUpdate_tx_body_0, bound *string) (Row_NestedUpdate_tx_body_0, bool)
	Node_NestedUpdate_tx_body_1(ports PortsNR_NestedUpdate_tx_body_1, bound *string) (Row_NestedUpdate_tx_body_1, bool)
}
...
func RunNativeRawStruct_NestedUpdate[H Handler_NestedUpdate](handlers H, in In_NestedUpdate) (T2, error) {
	_ = in
	var t_tx_body_0 T0
	...
	// ── op 'tx_body_0' (Update) ──
	ports_tx_body_0 := PortsNR_NestedUpdate_tx_body_0{Sql: "UPDATE benchmark_users SET name = ? WHERE id = ? RETURNING id, name", P0: in.Name, P1: in.User_id}
	row_tx_body_0, row_tx_body_0Resolved := handlers.Node_NestedUpdate_tx_body_0(ports_tx_body_0, nil)
	if !row_tx_body_0Resolved {
		return T2{}, &BehaviorError{Code: "UNKNOWN_COMPONENT", Message: "component 'Update' has no handler (fail-closed)"}
	}
	...
	t_tx_body_0.Name = row_tx_body_0.Name
	produced_tx_body_0 = true
	// ── op 'tx_body_1' (Update) ──
	ports_tx_body_1 := PortsNR_NestedUpdate_tx_body_1{Sql: "UPDATE benchmark_posts SET title = ? WHERE author_id = ? RETURNING id, title", P0: in.Title, P1: in.User_id}
	row_tx_body_1, row_tx_body_1Resolved := handlers.Node_NestedUpdate_tx_body_1(ports_tx_body_1, nil)
