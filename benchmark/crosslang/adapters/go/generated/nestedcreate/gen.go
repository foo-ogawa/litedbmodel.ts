...
// Row_NestedCreate_tx_body_0 — CONCRETE handler-result row (typed fields = the node's outType; + error signal).
type Row_NestedCreate_tx_body_0 struct {
	IsError bool
	Err     string
	Id int64 // "id"
}

// Row_NestedCreate_tx_body_1 — CONCRETE handler-result row (typed fields = the node's outType; + error signal).
type Row_NestedCreate_tx_body_1 struct {
	IsError bool
	Err     string
	Id int64 // "id"
	Author_id int64 // "author_id"
...
// Handler_NestedCreate — the CONCRETE per-component handler seam: one typed method
...
type Handler_NestedCreate interface {
	Node_NestedCreate_tx_body_0(ports PortsNR_NestedCreate_tx_body_0, bound *string) (Row_NestedCreate_tx_body_0, bool)
	Node_NestedCreate_tx_body_1(ports PortsNR_NestedCreate_tx_body_1, bound *string) (Row_NestedCreate_tx_body_1, bool)
}
...
func RunNativeRawStruct_NestedCreate[H Handler_NestedCreate](handlers H, in In_NestedCreate) (T2, error) {
	_ = in
	var t_tx_body_0 T0
	...
	row_tx_body_0, row_tx_body_0Resolved := handlers.Node_NestedCreate_tx_body_0(ports_tx_body_0, nil)
	...
	if produced_tx_body_0 {
		ports_tx_body_1 := PortsNR_NestedCreate_tx_body_1{Sql: "INSERT INTO benchmark_posts (author_id, title) VALUES (?, ?) RETURNING id, author_id, title", P0: t_tx_body_0.Id, P1: in.Title}
		row_tx_body_1, row_tx_body_1Resolved := handlers.Node_NestedCreate_tx_body_1(ports_tx_body_1, nil)
