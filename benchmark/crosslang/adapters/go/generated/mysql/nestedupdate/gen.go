...
func RunNativeRawStruct_NestedUpdate(handlers Handler_NestedUpdate, in In_NestedUpdate) (T1, error) {
	...
	// ── op 'tx_body_0' (Update) ──
	ports_tx_body_0 := PortsNR_NestedUpdate_tx_body_0{Sql: "UPDATE benchmark_users SET name = ? WHERE id = ?", P0: in.Name, P1: in.User_id}
	...
	// ── op 'tx_body_1' (Update) ──
	ports_tx_body_1 := PortsNR_NestedUpdate_tx_body_1{Sql: "UPDATE benchmark_posts SET title = ? WHERE author_id = ?", P0: in.Title, P1: in.User_id}
