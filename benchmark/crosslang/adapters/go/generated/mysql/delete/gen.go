...
func RunNativeRawStruct_Delete(handlers Handler_Delete, in In_Delete) (T2, error) {
	...
	// ── op 'tx_body_0' (Insert) ──
	ports_tx_body_0 := PortsNR_Delete_tx_body_0{Sql: "INSERT INTO benchmark_users (email, name) VALUES (?, ?) /*scp-reselect: SELECT id FROM benchmark_users WHERE id >= ? AND id < ? ORDER BY id ::binds:: L,H*/", P0: in.Email, P1: in.Name}
