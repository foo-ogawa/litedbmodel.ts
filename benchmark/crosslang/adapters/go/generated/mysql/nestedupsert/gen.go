...
func RunNativeRawStruct_NestedUpsert(handlers Handler_NestedUpsert, in In_NestedUpsert) (T2, error) {
	_ = in
	var t_tx_body_0 T0
	...
	// ── op 'tx_body_0' (Insert) ──
	ports_tx_body_0 := PortsNR_NestedUpsert_tx_body_0{Sql: "INSERT INTO benchmark_users (email, name) VALUES (?, ?) ON DUPLICATE KEY UPDATE email = VALUES(email), name = VALUES(name) /*scp-reselect: SELECT id FROM benchmark_users WHERE email = ? ORDER BY id ::binds:: p0*/", P0: in.Email, P1: in.Name}
	wire_tx_body_0, wire_tx_body_0Err := handlers.Node_NestedUpsert_tx_body_0(ports_tx_body_0, nil)
	...
	if produced_tx_body_0 {
		ports_tx_body_1 := PortsNR_NestedUpsert_tx_body_1{Sql: "INSERT INTO benchmark_posts (author_id, title) VALUES (?, ?)", P0: t_tx_body_0.Id, P1: in.Title}
		wire_tx_body_1, wire_tx_body_1Err := handlers.Node_NestedUpsert_tx_body_1(ports_tx_body_1, nil)
