...
// PortsNR_Update_n0 — NATIVE ports for node 'n0' (Update). Typed fields per the
...
func RunNativeRawStruct_Update(handlers Handler_Update, in In_Update) ([]T0, error) {
	_ = in
	var t_n0 []T0
	produced_n0 := false
	_ = t_n0
	_ = produced_n0
	// ── op 'n0' (Update) ──
	ports_n0 := PortsNR_Update_n0{Sql: "UPDATE benchmark_users SET name = $1 WHERE id = $2", P0: in.Name, P1: in.Id}
	wire_n0, wire_n0Err := handlers.Node_Update_n0(ports_n0, nil)
	if wire_n0Err != nil {
...
var ComponentNamesNativeRaw = []string{"Update"}
