...
func RunNativeRawStruct_Delete(handlers Handler_Delete, in In_Delete) (T2, error) {
	...
	// ── op 'tx_body_0' (Insert) ──
	ports_tx_body_0 := PortsNR_Delete_tx_body_0{Sql: "INSERT INTO benchmark_users (email, name) VALUES ($1, $2) RETURNING id", P0: in.Email, P1: in.Name}
	...
	if produced_tx_body_0 {
		ports_tx_body_1 := PortsNR_Delete_tx_body_1{Sql: "DELETE FROM benchmark_users WHERE id = $1", P0: t_tx_body_0.Id}
