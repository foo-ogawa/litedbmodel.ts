...
func RunNativeRawStruct_NestedCreate(handlers Handler_NestedCreate, in In_NestedCreate) (T2, error) {
	...
	// ── op 'tx_body_0' (Insert) ──
	ports_tx_body_0 := PortsNR_NestedCreate_tx_body_0{Sql: "INSERT INTO benchmark_users (email, name) VALUES ($1, $2) RETURNING id", P0: in.Email, P1: in.Name}
	...
	if produced_tx_body_0 {
		ports_tx_body_1 := PortsNR_NestedCreate_tx_body_1{Sql: "INSERT INTO benchmark_posts (author_id, title) VALUES ($1, $2)", P0: t_tx_body_0.Id, P1: in.Title}
