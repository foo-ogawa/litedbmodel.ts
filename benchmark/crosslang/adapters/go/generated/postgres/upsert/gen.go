...
func RunNativeRawStruct_Upsert(handlers Handler_Upsert, in In_Upsert) ([]T0, error) {
	...
	_ = produced_n0
	// ── op 'n0' (Insert) ──
	ports_n0 := PortsNR_Upsert_n0{Sql: "INSERT INTO benchmark_users (email, name) VALUES ($1, $2) ON CONFLICT (email) DO UPDATE SET email = excluded.email, name = excluded.name RETURNING id", P0: in.Email, P1: in.Name}
