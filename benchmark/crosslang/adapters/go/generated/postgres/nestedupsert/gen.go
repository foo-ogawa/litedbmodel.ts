...
func RunNativeRawStruct_NestedUpsert(handlers Handler_NestedUpsert, in In_NestedUpsert) (T2, error) {
	...
	// ── op 'tx_body_0' (Insert) ──
	ports_tx_body_0 := PortsNR_NestedUpsert_tx_body_0{Sql: "INSERT INTO benchmark_users (email, name) VALUES ($1, $2) ON CONFLICT (email) DO UPDATE SET email = excluded.email, name = excluded.name RETURNING id", P0: in.Email, P1: in.Name}
	...
	if produced_tx_body_0 {
		ports_tx_body_1 := PortsNR_NestedUpsert_tx_body_1{Sql: "INSERT INTO benchmark_posts (author_id, title) VALUES ($1, $2)", P0: t_tx_body_0.Id, P1: in.Title}
