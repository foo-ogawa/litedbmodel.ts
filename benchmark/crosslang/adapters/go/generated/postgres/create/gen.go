...
// PortsNR_Create_n0 — NATIVE ports for node 'n0' (Insert). Typed fields per the
...
func RunNativeRawStruct_Create(handlers Handler_Create, in In_Create) ([]T0, error) {
	_ = in
	var t_n0 []T0
	produced_n0 := false
	_ = t_n0
	_ = produced_n0
	// ── op 'n0' (Insert) ──
	ports_n0 := PortsNR_Create_n0{Sql: "INSERT INTO benchmark_users (email, name) VALUES ($1, $2)", P0: in.Email, P1: in.Name}
	wire_n0, wire_n0Err := handlers.Node_Create_n0(ports_n0, nil)
	if wire_n0Err != nil {
...
var ComponentNamesNativeRaw = []string{"Create"}
