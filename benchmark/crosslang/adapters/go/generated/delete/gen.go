...
// Row_Delete_tx_body_0 — CONCRETE handler-result row (typed fields = the node's outType; + error signal).
type Row_Delete_tx_body_0 struct {
	IsError bool
	Err     string
	Id int64 // "id"
}

// Row_Delete_tx_body_1 — CONCRETE handler-result row (typed fields = the node's outType; + error signal).
type Row_Delete_tx_body_1 struct {
	IsError bool
	Err     string
	Changes int64 // "changes"
	LastInsertRowid int64 // "lastInsertRowid"
...
// Handler_Delete — the CONCRETE per-component handler seam: one typed method
...
type Handler_Delete interface {
	Node_Delete_tx_body_0(ports PortsNR_Delete_tx_body_0, bound *string) (Row_Delete_tx_body_0, bool)
	Node_Delete_tx_body_1(ports PortsNR_Delete_tx_body_1, bound *string) (Row_Delete_tx_body_1, bool)
}
...
func RunNativeRawStruct_Delete[H Handler_Delete](handlers H, in In_Delete) (T2, error) {
	_ = in
	var t_tx_body_0 T0
	...
	row_tx_body_0, row_tx_body_0Resolved := handlers.Node_Delete_tx_body_0(ports_tx_body_0, nil)
	...
	if produced_tx_body_0 {
		...
		row_tx_body_1, row_tx_body_1Resolved := handlers.Node_Delete_tx_body_1(ports_tx_body_1, nil)
		if !row_tx_body_1Resolved {
			return T2{}, &BehaviorError{Code: "UNKNOWN_COMPONENT", Message: "component 'Delete' has no handler (fail-closed)"}
		}
		...
		t_tx_body_1.Changes = row_tx_body_1.Changes
		t_tx_body_1.LastInsertRowid = row_tx_body_1.LastInsertRowid
